  ...
  return (
    <div className="hidden md:flex h-screen w-64 flex-col border-r bg-white dark:bg-gray-950 sticky top-0">
      ...
      <div className="border-t p-4">
         <form action={signOut}>
            <button type="submit" className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors">
